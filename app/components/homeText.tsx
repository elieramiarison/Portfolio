...
const HomeText = () => {
    ...
    return (
        ...
        //                     Elie Ramiarison
        //                 </h1>
        //                 {/* <h1 className='font-normal lg:text-2xl md:text-2xl sm:text-4xl text-2xl'>Développeur Web FullStack</h1> */}
        //                 <AnimatedTypingText />
        ...
        //                         className='bg-gradient-to-r from-[#c000b0] to-[#4a0a9d] py-2.5 px-3 rounded-xl text-white cursor-pointer'>
        //                         Télécharger mon CV
        //                     </a>
        //                 </div>
        ...
        //                     <Link href='https://github.com/elieramiarison/' target='_blank' className='cursor-pointer'>
        ...
        //                 <div
        //                     className="absolute top-14 right-2 z-0 opacity-80 w-[5vw] md:w-[30vw] h-[5vw] md:h-[30vw]"
        //                     style={{
        ...
        //                 ></div>
        //                 <div
        //                     className="absolute top-10 right-0 z-0 opacity-60 md:w-[20vw] md:h-[20vw] h-[5vw] w-[5vw]"
        //                     style={{
        ...
        //             <Image src="/abstract4.png" alt='abstract' width={100} height={100} className='w-20 h-50 absolute right-0 lg:top-14 md:top-14 sm:top-20 top-[4.8rem] z-[-5rem] opacity-55' />
        //             {/* SVG deco */}
        //             <Image src="/sv.svg" alt='abstract' width={100} height={100} className='w-10 h-10 absolute lg:right-[27rem] lg:left-auto md:right-[20rem] md:left-auto sm:left-5 left-8 top-20 opacity-80 color-[#c000b0]' />
        //             <Image src="/sv2.svg" alt='abstract' width={100} height={100} className='w-8 h-8 absolute lg:left-20 lg:right-auto md:left-20 md:right-auto sm:right-5 right-5 bottom-[6rem] opacity-80 color-[#c000b0] lg:top-[30rem] md:top-[30rem] sm:top-[28rem] top-[28rem]' />
        //             <div
        //                 className="
        //                 absolute
