            ...
            <div className="text-center">
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl lg:p-4 md:p-4 sm:p-4 p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/rendezia.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] h-[10rem] object-cover" onClick={() => setToggle(true)} />
               ...
               opacity-0 translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500">Jetez un oeil <FaLink size={12} /></a>
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl lg:p-4 md:p-4 sm:p-4 p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/pharma.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] h-[10rem] object-cover" onClick={() => setToggle(true)} />
                                <a href="https://rendezia-rdv-medical.vercel.app/" target="blank" rel="noopener noreferrer" className="absolute bottom-2 right-5 bg-[#090909b6] text-sm px-4 py-1 rounded-2xl flex items-center gap-1 text-white
               opacity-0 translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500">Jetez un oeil <FaLink size={12} /></a>
                            </div>
                            <div className="flex flex-col justify-start items-start pt-2 gap-2 lg:w-[24rem] md:w-[24rem] sm:w-[24rem] w-[20rem]">
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl lg:p-4 md:p-4 sm:p-4 p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/ancien-portfolio.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] h-[10rem] object-cover" onClick={() => setToggle(true)} />
               ...
               opacity-0 translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500">Jetez un oeil <FaLink size={12} /></a>
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl lg:p-4 md:p-4 sm:p-4 p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/beyAft.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] h-[10rem] object-cover" onClick={() => setToggle(true)} />
                            </div>
                            <div className="flex flex-col justify-start items-start pt-2 gap-2 lg:w-[24rem] md:w-[24rem] sm:w-[24rem] w-[20rem]">
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/back-off.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] object-cover" onClick={() => setToggle(true)} />
                                <a href="https://rendezia-rdv-medical.vercel.app/" target="blank" rel="noopener noreferrer" className="absolute bottom-2 right-5 bg-[#090909b6] text-sm px-4 py-1 rounded-2xl flex items-center gap-1 text-white
               opacity-0 translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500">Jetez un oeil <FaLink size={12} /></a>
                            </div>
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/site-vitrine.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] object-cover" onClick={() => setToggle(true)} />
               ...
               opacity-0 translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500">Jetez un oeil <FaLink size={12} /></a>
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/psyKozy1.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] object-cover" onClick={() => setToggle(true)} />
                            </div>
                            <div className="flex flex-col justify-start items-start pt-2 gap-2">
                    ...
                    <div className=" justify-center items-center gap-10 flex flex-wrap">
                        <div className="bg-[#4a0a9d69] backdrop-blur-3xl p-4 rounded-md">
                            <div className="relative group w-fit" >
                                <img src="/portfolio2.jpg" alt="photo" width={100} height={100} className="lg:w-[24rem] lg:h-[14rem] md:w-[24rem] md:h-[14rem] sm:w-[24rem] sm:h-[14rem] w-[20rem] object-cover" onClick={() => setToggle(true)} />
